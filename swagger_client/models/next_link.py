...
class NextLink(object):
    ...
    def __init__(self, next=None):  # noqa: E501
        """NextLink - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def next(self):
        """Gets the next of this NextLink.  # noqa: E501
        ...
        :return: The next of this NextLink.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this NextLink.

        RFC 3986 URI representing the location of the next page of results. Omitted when there are no results, or the current page is the last.  # noqa: E501

        :param next: The next of this NextLink.  # noqa: E501
        :type: str
        """
        if next is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NextLink):
            return False
